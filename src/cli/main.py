...
def _enforce_decision_gate(result: PipelineOutput, model_path: str) -> tuple[bool, str]:
    ...
    if decision == DeploymentDecision.UNSUPPORTED:
        reason = (
            ...
            "Recommendation: do not deploy until issues are fixed."
        )
        return True, reason
        ...
        reason = (
            ...
            f"Failures: {result.fail_count}\n"
            f"Warnings: {result.warn_count}\n"
            "Recommendation: run with close monitoring and guardrails."
        )
        return True, reason
        ...
        reason = (
            ...
            f"Failures: {result.fail_count}\n"
            f"Warnings: {result.warn_count}\n"
            "Recommendation: proceed with standard runtime monitoring."
        )
        return True, reason
        ...
        reason = (
            ...
            "Recommendation: treat deployment as high risk and review diagnostics."
        )
        return True, reason
